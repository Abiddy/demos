...
const ORDER_URL = 'https://www.lomelis.com/';
const WAITLIST_URL = 'https://www.lomelis.com/';
const PHONE = '(310) 323-7993';
const PHONE_TEL = 'tel:+13103237993';
const ADDRESS = '2223 W Redondo Beach Blvd, Gardena, CA 90247';
const MAPS =
  'https://maps.google.com/?q=2223+W+Redondo+Beach+Blvd,+Gardena,+CA+90247';

const orbitDishes = [
  {
    src: '/lomelis/pizza.jpg',
    name: 'Deluxe Pizza',
    description: 'Olives, peppers, mushrooms & melted mozzarella on a golden crust.',
    price: '$22.95',
  },
  {
    src: '/lomelis/parm.jpg',
    name: 'Chicken Parmigiana',
    description: 'Breaded cutlet, marinara, melted cheese — served with spaghetti.',
    price: '$19.95',
  },
  {
    src: '/lomelis/alfredo.jpg',
    name: 'Chicken Fettuccine Alfredo',
    description: 'Creamy Alfredo with broccoli, cauliflower & tender chicken.',
    price: '$18.95',
  },
  {
    src: '/lomelis/soup.jpg',
    name: 'Minestrone Soup',
    description: 'Hearty tomato broth with shell pasta & garden vegetables.',
    price: '$7.95',
  },
  {
    src: '/lomelis/pizza.jpg',
    name: 'House Specialty Pizza',
    description: 'Slow-raised dough topped with classic Italian favorites.',
    price: '$21.95',
  },
  {
    src: '/lomelis/parm.jpg',
    name: 'Spaghetti & Cutlet',
    description: 'Red-sauce classic with a crispy cutlet and melted cheese.',
    price: '$18.50',
  },
] as const;
...
export function LomelisLanding() {
  ...
  return (
    <div className="lomelis-page">
        ...
        <div className="sticky top-0 w-full h-screen overflow-hidden text-white">
          ...
          >
            ...
            >
              ...
              >
                <tspan fontSize="90">Lomeli&apos;s</tspan>
                <tspan fontSize="28.8" dx="4" dy="-40">
                  ©
                </tspan>
              </text>
            </svg>
          ...
          <div className="absolute inset-0 z-[60] pointer-events-none">
            ...
            <div className="absolute bottom-16 right-[6vw] md:right-[10vw] flex flex-col items-start z-10 pointer-events-auto">
              <motion.p
                ...
                style={{ y: yElement, filter: filterText, opacity: textOpacity }}
              >
                PIZZAS, PASTAS &amp; RED-SAUCE CLASSICS IN A WARM, DIMLY LIT
                SPACE WITH COZY BOOTHS.
              </motion.p>
              <motion.div
          ...
          >
            ...
            >
              <span style={{ fontSize: '40px' }}>Lomeli&apos;s</span>
              <span
                style={{
                  fontSize: '14px',
                  marginLeft: '4px',
            ...
            <a
              ...
              aria-label="Menu"
            >
              <div className="absolute inset-0 bg-black rounded-[50%] -rotate-[15deg]" />
              <svg
      ...
      {/* Our Story */}
      <section className="bg-[#F7F1E8] text-black px-6 md:px-16 py-20 md:py-28">
        <div className="mx-auto max-w-5xl grid md:grid-cols-[1.1fr_0.9fr] gap-12 md:gap-16 items-center">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-6xl leading-[1.05] mb-6">
              A Gardena staple since 1978
            </h2>
            <p className="font-sans text-base md:text-lg text-black/75 leading-relaxed mb-5">
              Lomeli&apos;s was founded with a passion for delicious Italian
              food. Carlo E. Lomeli, inspired by his training as an Italian chef
              at Sala&apos;s, created a menu that celebrates classic dishes made
              with love and the finest ingredients.
            </p>
            <p className="font-sans text-base md:text-lg text-black/75 leading-relaxed">
              Today we&apos;re a cornerstone of Gardena cuisine — pizzas,
              pastas, and red-sauce classics in a warm, dimly lit space with cozy
              booths.
            </p>
          </div>
          <div className="relative aspect-[4/5] overflow-hidden bg-black/5">
            <img
              src="/lomelis/parm.jpg"
              alt="Chicken Parmigiana at Lomeli's"
      ...
      {/* Menu highlights */}
      <section className="bg-black text-white px-6 md:px-16 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12 md:mb-16">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex self-start md:self-auto items-center rounded-full bg-white text-black px-7 py-3 font-serif uppercase tracking-[0.1em] text-sm hover:bg-[#FDFFB7] transition-colors"
            >
              Full menu
            </a>
          </div>
            ...
            {FEATURED.map((dish) => (
              <article key={dish.name} className="group">
                ...
                <div className="flex items-baseline justify-between gap-3 mb-2">
                  ...
                  <span className="font-serif text-lg text-[#FDFFB7] shrink-0">
                    {dish.price}
                  </span>
                </div>
      ...
      <section className="relative px-6 md:px-16 py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center text-white">
          ...
          <p className="font-sans text-base md:text-lg text-white/80 leading-relaxed mb-8">
            Affordable party trays — no dishes, more time to enjoy the party.
            Catering available for orders over $400. Call early during busy
            seasons.
          </p>
          <a
            href={PHONE_TEL}
            className="inline-flex items-center rounded-full bg-[#FDFFB7] text-black px-8 py-3.5 font-serif uppercase tracking-[0.1em] text-sm hover:bg-white transition-colors"
          >
            Call {PHONE}
          </a>
        </div>
      ...
      <section className="bg-[#F7F1E8] text-black px-6 md:px-16 py-20 md:py-28">
        <div className="mx-auto max-w-5xl grid md:grid-cols-3 gap-10 md:gap-8">
          <div>
            <div className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-black text-white mb-5">
              <MapPin size={18} />
            </div>
          ...
          <div>
            ...
            <a
              href={PHONE_TEL}
              className="block font-serif text-xl mb-3 hover:opacity-70"
            >
              {PHONE}
            </a>
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-full border border-black/25 px-5 py-2.5 font-sans text-xs uppercase tracking-wider hover:bg-black hover:text-white transition-colors"
              >
                Join waitlist
              </a>
            </div>
      ...
      <footer className="bg-black text-white/55 px-6 md:px-16 py-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs tracking-wide">
        ...
        <span>Gardena, CA · Italian classics since 1978</span>
        <a
          href={ORDER_URL}
          target="_blank"
          rel="noreferrer"
